...
const TerminalHeader = memo((props: TerminalHeaderProps) => {
  ...
  return (
    <header className="flex items-center justify-between border-[#333] border-b bg-[#2d2d2d] px-5 py-3">
        ...
        <div className="flex items-center gap-5 text-sm">
          ...
          <div className="flex items-center gap-1 text-gray-400">
            ...
            {Array.from({ length: currentParticipants ?? 0 }, (_, index) => (
              <div
                key={`active-dot-${currentParticipants}-${index}`}
            ...
            {Array.from(
              ...
              (_, index) => (
                <div
                  key={`empty-dot-${maxParticipants}-${currentParticipants}-${index}`}
...
const TerminalFooter = memo((props: TerminalFooterProps) => {
  ...
  return (
    <footer className="flex justify-between border-[#333] border-t bg-[#2d2d2d] px-5 py-2 text-gray-400 text-xs">
      <span>Ready</span>
...
export const TerminalLayout = memo((props: TerminalLayoutProps) => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden font-cascadia">
